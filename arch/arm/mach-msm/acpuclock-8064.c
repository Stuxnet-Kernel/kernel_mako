...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  192000, PLL_8, 0, 0x00 },  800000, 1050000, 1 },
	[1]  = { {  384000, HFPLL, 2, 0x20 }, 950000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 950000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 950000, 1050000, 2 },
	[4]  = { {  594000, HFPLL, 1, 0x16 }, 950000, 1050000, 2 },
	[5]  = { {  648000, HFPLL, 1, 0x18 }, 950000, 1050000, 4 },
	[6]  = { {  702000, HFPLL, 1, 0x1A }, 1050000, 1150000, 4 },
	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1050000, 1150000, 4 },
	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1050000, 1150000, 4 },
	[9]  = { {  864000, HFPLL, 1, 0x20 }, 1050000, 1150000, 4 },
	[10] = { {  918000, HFPLL, 1, 0x22 }, 1050000, 1150000, 5 },
	[11] = { {  972000, HFPLL, 1, 0x24 }, 1050000, 1150000, 5 },
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {   384000, HFPLL, 2, 0x20 }, L2(5),   875000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {   384000, HFPLL, 2, 0x20 }, L2(5),   825000 },
	...
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(16), 1125000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {   384000, HFPLL, 2, 0x20 }, L2(5),   775000 },
	...
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(16), 1075000 },
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(16), 1050000 },
 	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(16), 1075000 },
	{ 0, { 0 } }
};
